	...
	public void display(PApplet p){
		...
		*/
	    ...
	    case 0:
	    	...
	    	p.image(animU[currentFrame],position.x-48,position.y-48);
	    	break;
	    case 1:
	    	//p.text("right",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animUR[currentFrame],position.x-48,position.y-48);
	    	break;
	    case 2:
	    	//p.text("down",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animR[currentFrame],position.x-48,position.y-48);
	    	break;
	    case 3:
	    	//p.text("left",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animDR[currentFrame],position.x-48,position.y-48);
	    	break;
	    case 4:
	    	//p.text("left",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animD[currentFrame],position.x-48,position.y-48);
	    	break;
	    case 5:
	    	//p.text("left",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animDL[currentFrame],position.x-48,position.y-48);
	    	break;	
	    case 6:
	    	//p.text("left",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animL[currentFrame],position.x-48,position.y-48);
	    	break;	
	    case 7:
	    	//p.text("left",10,10);
	    	if (p.millis() > previousDisplayTime + deltaTime) {
	    	...
	    	p.image(animUL[currentFrame],position.x-48,position.y-48);
	    	break;	
	    }
		////////////////////
