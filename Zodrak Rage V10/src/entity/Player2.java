...
public class Player2 extends PApplet {
	...
	*/
	...
	public void display(PApplet p,PVector MP){
		...
		case 0:
	    	...
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdRight[currentFrame],position.x-22,position.y-22);
	    	}
	    	
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxRight[currentFrame],position.x-22,position.y-22);
	    	}
	    	
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxRight[currentFrame],position.x-22,position.y-22);
	    	}
	    	
	    	if(idle == true && axeInHand == false){
		    	if (p.millis() > previousDisplayTime + deltaTime) {
		    	    currentFrame++;
		    	    if (currentFrame > 7) { 
		    	      currentFrame = 0;
		...
		case 1:
	    	...
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdDownR[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxDownR[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxDownR[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(idle == true && axeInHand == false){
	    		...
	    		p.image(animDownR[currentFrame],position.x-22,position.y-22);
	    	}
		...
		case 2:
	    	...
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdDown[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxDown[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxDown[currentFrame],position.x-22,position.y-22);
	    	}
		...
		case 3:
	    	...
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdDownL[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxDownL[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxDownL[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(idle == true && axeInHand == false){
	    		...
	    		p.image(animDownL[currentFrame],position.x-22,position.y-22);
	    	}
		...
		case 4:
	    	...
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdLeft[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxLeft[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxLeft[currentFrame],position.x-22,position.y-22);
	    	}
		...
		case 5:
	    	...
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdUpL[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxUpL[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxUpL[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(idle == true && axeInHand == false){
	    		...
	    		p.image(animUpL[currentFrame],position.x-22,position.y-22);
	    	}
		...
		case 6:
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdUp[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxUp[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxUp[currentFrame],position.x-22,position.y-22);
	    	}
		...
		case 7:
	    	if(idle == false && axeInHand == false){
	    		...
	    		p.image(animIdUpR[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == false && chop == false){
	    		...
	    		p.image(animIdAxUpR[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(axeInHand == true && idleAxe == true && chop == false){
	    		...
	    		p.image(animAxUpR[currentFrame],position.x-22,position.y-22);
	    	}
	    	...
	    	if(idle == true && axeInHand == false){
	    		...
	    		p.image(animUpR[currentFrame],position.x-22,position.y-22);
	    	}
	...
	public void displayBar(PVector pos, PVector screen){ //chiffre à modif 
		...
		//1: HP
		parent.fill(255,0,0);
		parent.rect(pos.x - screen.x +50 , pos.y + screen.y -175 , (HP/HPMax)*200, 10);
		parent.image(logoPV, pos.x - screen.x +18 , pos.y + screen.y -185);
		parent.noFill();
